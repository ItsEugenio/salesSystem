...
export class CreateProductComponent implements OnInit {
  ...
  save() {
    const expDate = new Date(this.formProduct.get('expDate').value);
    this.formProduct.get('expDate').setValue(expDate.toISOString().slice(0, 10));
    console.log('Product', this.formProduct.value);
